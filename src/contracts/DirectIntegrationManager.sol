    ...
    IDirectIntegrationManager
{
    ...
    mapping(address => mapping(bytes32 => ParameterIntegrationSettings))
        internal _settings;
    ...
    function getExchangeParameters(
        ...
        ParameterIntegrationSettings memory storedOverrides = _settings[
            integration
        ][currencyKey];
        ...
        return
            ParameterIntegrationSettings({
                ...
                dexPriceAggregator: storedOverrides.dexPriceAggregator !=
                    address(0)
                    ? storedOverrides.dexPriceAggregator
                    : flexibleStorage().getAddressValue(
                        CONTRACT_NAME_EXCHANGE_RATES,
                        SETTING_DEX_PRICE_AGGREGATOR
                    ),
                atomicEquivalentForDexPricing: storedOverrides
                    .atomicEquivalentForDexPricing != address(0)
                ...
                atomicTwapWindow: storedOverrides.atomicTwapWindow > 0
                    ...
                    : getAtomicTwapWindow(),
                atomicMaxVolumePerBlock: storedOverrides
                    .atomicMaxVolumePerBlock > 0
                    ? storedOverrides.atomicMaxVolumePerBlock
                    : getAtomicMaxVolumePerBlock(),
                atomicVolatilityConsiderationWindow: storedOverrides
                ...
                atomicVolatilityUpdateThreshold: storedOverrides
