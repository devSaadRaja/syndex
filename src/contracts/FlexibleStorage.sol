...
contract FlexibleStorage is ContractStorage {
    ...
    function getUIntValues(
        ...
        mapping(bytes32 => uint) storage data = uintStorage[
            hashes[contractName]
        ];
