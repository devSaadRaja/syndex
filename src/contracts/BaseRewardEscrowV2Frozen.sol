...
contract BaseRewardEscrowV2Frozen is
    Ownable,
    ...
    MixinResolver
{
     ...
     * @return endTime The vesting entry object and rate per second emission.
     */
    ...
    function _reduceAccountEscrowBalances(
        ...
        totalEscrowedAccountBalance[_account] = totalEscrowedAccountBalance[
            _account
        ].sub(_amount);
    }
    ...
    function mergeAccount(
        ...
        require(
            nominatedReceiver[accountToMerge] == msg.sender,
        ...
        totalEscrowedAccountBalance[
            accountToMerge
        ] = totalEscrowedAccountBalance[accountToMerge].sub(
            totalEscrowAmountMerged
        );
        totalEscrowedAccountBalance[msg.sender] = totalEscrowedAccountBalance[
            msg.sender
        ].add(totalEscrowAmountMerged);
